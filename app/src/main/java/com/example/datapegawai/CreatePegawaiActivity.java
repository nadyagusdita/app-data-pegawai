...
public class CreatePegawaiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_pegawai);
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                createPegawai(nama, provinsi, kabupaten, kecamatan, kelurahan, jalan);
            }
        });
    }
    ...
    private void createPegawai(String nama, String provinsi, String kabupaten, String kecamatan, String kelurahan, String jalan) {
        ApiService apiService = ApiClient.getClient().create(ApiService.class);
        Call<Pegawai> call = apiService.createPegawai(nama, provinsi, kabupaten, kecamatan, kelurahan, jalan);
        call.enqueue(new Callback<Pegawai>() {
            @Override
            public void onResponse(Call<Pegawai> call, Response<Pegawai> response) {
                if (response.isSuccessful() && response.body() != null) {
                    Toast.makeText(getApplicationContext(), "Success to add pegawai", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getApplicationContext(), MainActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(getApplicationContext(), "Failed to add pegawai", Toast.LENGTH_SHORT).show();
                }
            }
